...
GlobalState() {
    RunWait, komorebic.exe global-state, , Hide
}

Gui() {
    RunWait, komorebic.exe gui, , Hide
}
...
MoveToMonitorWorkspace(target_monitor, target_workspace) {
    RunWait, komorebic.exe move-to-monitor-workspace %target_monitor% %target_workspace%, , Hide
}
...
CycleMoveWorkspaceToMonitor(cycle_direction) {
    RunWait, komorebic.exe cycle-move-workspace-to-monitor %cycle_direction%, , Hide
}
...
PromoteWindow(operation_direction) {
    RunWait, komorebic.exe promote-window %operation_direction%, , Hide
}
...
Border(boolean_state) {
    RunWait, komorebic.exe border %boolean_state%, , Hide
}

BorderColour(r, g, b, window_kind) {
    RunWait, komorebic.exe border-colour %r% %g% %b% --window-kind %window_kind%, , Hide
}

BorderWidth(width) {
    RunWait, komorebic.exe border-width %width%, , Hide
}

BorderOffset(offset) {
    RunWait, komorebic.exe border-offset %offset%, , Hide
}
